...
public class Ex1_Tester {
	...
	public static void checkLogic() {
		...
		System.err.println("size1:"+sc1.size());
		...
		System.err.println("size2:"+sc2.size());
		System.out.println("area2: "+sc2.sumArea());

		Const.show(sc1);
		Const.show(sc2);
		System.out.println("size 1:"+sc1.size());
		System.out.println("size 2:"+sc2.size());
		System.out.println("number of comparision1:");
